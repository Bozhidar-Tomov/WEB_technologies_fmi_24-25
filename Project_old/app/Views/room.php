...
<main class="room-main" aria-label="Room View">
    <div class="cue-controls-fixed" aria-label="Cue Controls">
        <button id="flashCueToggle" class="cue-btn flash-cue" aria-label="Toggle Flash Cue" type="button" title="Flash Cue">
            <span id="flashCueIcon" class="cue-icon">⚡</span>
        </button>
        <button id="beepCueToggle" class="cue-btn beep-cue" aria-label="Toggle Beep Cue" type="button" title="Beep Cue">
            <span id="beepCueIcon" class="cue-icon">🔊</span>
        </button>
    </div>
...
<div id="micRecordingIndicator" class="mic-recording-indicator" style="display:none;">
